...
public class NotifyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnNotifyApps.setOnClickListener(view -> {
            btnNotifyApps.setBackground(ContextCompat.getDrawable(Objects.requireNonNull(getContext()),R.color.main_color));
        ...
        btnNotifyUser.setOnClickListener(view -> {
            ...
            btnNotifyUser.setBackground(ContextCompat.getDrawable(Objects.requireNonNull(getContext()),R.color.main_color));
